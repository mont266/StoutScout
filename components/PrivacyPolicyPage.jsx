...
const PrivacyPolicyPage = ({ onBack }) => {
    return (
        <LegalPageWrapper title="Privacy Policy" onBack={onBack}>
            ...
            <ul className="list-disc list-inside space-y-2 pl-4">
                <li><strong>Publicly on the Service:</strong> Your username, avatar, level, rank, individual ratings, comments, and any photographs you have uploaded are publicly visible to other users.</li>
