    ...
    return (
        <LegalPageWrapper title="Privacy Policy" onBack={onBack}>
            ...
            <ul className="list-disc list-inside space-y-2 pl-4">
                ...
                <li><strong>Account Deletion:</strong> If you wish to delete your account, please contact us at [Your Support Email Address]. Please note that upon deletion, we may retain certain anonymized or aggregated data that does not identify you.</li>
            </ul>
