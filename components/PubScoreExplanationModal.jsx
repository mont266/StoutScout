        ...
        <div className="flex-grow overflow-y-auto px-6">
          ...
          <div className="space-y-4">
              <div className="flex items-start space-x-4 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  ...
                  <div>
                      <h3 className="font-semibold text-gray-800 dark:text-white">Pint Quality (70% weight)</h3>
              ...
              <div className="flex items-start space-x-4 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  ...
                  <div>
                      <h3 className="font-semibold text-gray-800 dark:text-white">Pint Price (30% weight)</h3>
