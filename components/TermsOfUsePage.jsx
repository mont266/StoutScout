    ...
    return (
        <LegalPageWrapper title="Terms of Use" onBack={onBack}>
            ...
            <ul className="list-disc list-inside space-y-2 pl-4">
                ...
                <li><strong>Personal Safety:</strong> You are solely responsible for your own safety and the safety of your group while participating in a pub crawl. You should always exercise caution, be aware of your surroundings, and follow local laws and regulations.</li>
                <li><strong>Responsible Drinking:</strong> Stoutly promotes responsible drinking. You agree to consume alcohol responsibly and within your limits. Never drink and drive. We are not responsible for any intoxication, health issues, or actions taken by you or any third party as a result of consuming alcohol during a pub crawl.</li>
